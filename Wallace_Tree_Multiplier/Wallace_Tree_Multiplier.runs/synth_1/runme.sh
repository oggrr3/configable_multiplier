...
HD_PWD='D:/Documents/Dai_hoc/SISLAB_KLTN/do_an/Wallace_Tree_Multiply_RTL_Project/Wallace_Tree_Multiplier/Wallace_Tree_Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log configurable_multiplication.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source configurable_multiplication.tcl
