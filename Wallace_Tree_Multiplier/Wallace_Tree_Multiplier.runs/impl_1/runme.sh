...
HD_PWD='D:/Documents/Dai_hoc/SISLAB_KLTN/do_an/Wallace_Tree_Multiply_RTL_Project/Wallace_Tree_Multiplier/Wallace_Tree_Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log configurable_multiplication.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source configurable_multiplication.tcl -notrace
